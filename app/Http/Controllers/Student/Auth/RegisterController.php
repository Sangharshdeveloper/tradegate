...
use App\Http\Requests\Student\VendorAddRequest;
...
class RegisterController extends BaseController
{
    ...
    public function __construct(
        ...
        private readonly DropshipperService $vendorService,
    ...
    public function getView():View|RedirectResponse
    {
        ...
        $helpTopics = $this->helpTopicRepo->getListWhere(
            ...
            dataLimit: 'all');
        return view(VIEW_FILE_NAMES[Auth::REGISTRATION[VIEW]],compact('vendorRegistrationHeader','vendorRegistrationReasons','sellWithUs','downloadVendorApp','helpTopics','businessProcess','businessProcessStep'));
    }
