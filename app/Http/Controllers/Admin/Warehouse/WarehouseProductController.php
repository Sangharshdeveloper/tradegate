...
class WarehouseProductController extends BaseController
{
    ...
    {
        return $this->getListViewWare(request: $request, type: ($type == 'vendor' ? 'seller' : 'ware_house'));
    }
    ...
    public function getAddView(): View
    {
        ...
        return view(Product::ADD_IN_WAREHOUSE[VIEW], compact('categories', 'brands', 'brandSetting', 'digitalProductSetting', 'colors', 'attributes', 'languages', 'defaultLanguage', 'digitalProductFileTypes', 'digitalProductAuthors', 'publishingHouseList'));
    }
    ...
    public function add(ProductAddRequest $request, ProductService $service): JsonResponse|RedirectResponse
    {
        ...
        $dataArray = $service->getAddProductData(request: $request, addedBy: 'admin',fromWareHouse : '1');
    ...
    public function getListViewWare(Request $request, string $type): View
    {
        $filters = [
            'from_warehouse' => '1',
            // 'added_by' => $type,
        ...
        $products = $this->productRepo->getListWhereWarehouseProducts(orderBy: ['id' => 'desc'], searchValue: $request['searchValue'], filters: $filters, dataLimit: getWebConfig(name: WebConfigKey::PAGINATION_LIMIT));
        ...
        return view(Product::WAREHOUSE_PRODUCT_LIST[VIEW], compact('products', 'sellers', 'brands',
