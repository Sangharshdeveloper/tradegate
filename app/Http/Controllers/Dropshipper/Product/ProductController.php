...
class ProductController extends BaseController
{
    ...
    public function getUpdateView(string|int $id): RedirectResponse|View
    {
        ...
        $product = $this->productRepo->getFirstWhereWithoutGlobalScope(params: ['id' => $id, 'added_by' =>  ['!=', 'vendor']], relations: ['translations', 'seoInfo', 'digitalProductAuthors', 'digitalProductPublishingHouse']);
        dd($product);
        if (!$product) {
