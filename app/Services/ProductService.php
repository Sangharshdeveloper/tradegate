...
class ProductService
{
    ...
    public function getAddProductData(object $request, string $addedBy, string $fromWareHouse): array
    {
        $storage = config('filesystems.disks.default') ?? 'public';
        ...
        return [
            'from_warehouse' => $fromWareHouse ?? '0',
            ...
            'request_status' => 1,
            // $addedBy == 'admin' ? 1 : (getWebConfig(name: 'new_product_approval') == 1 ? 0 : 1),
