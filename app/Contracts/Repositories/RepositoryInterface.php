...
interface RepositoryInterface
{
     ...
     * @return Collection|LengthAwarePaginator
     */
    public function getListWhere(array $orderBy=[], string $searchValue = null, array $filters = ['added_by' => 'dropshipper'], array $relations = [], int|string $dataLimit = DEFAULT_DATA_LIMIT, int $offset = null): Collection|LengthAwarePaginator;
