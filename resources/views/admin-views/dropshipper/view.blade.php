                ...
                <ul class="nav nav-tabs flex-wrap page-header-tabs">
                    <li class="nav-item">
                        <a class="nav-link active"
                           href="{{ route('admin.dropshippers.view', $seller['id']) }}">{{translate('shop_overview')}}</a>
                    </li>
                    @if ($seller['status']!="pending")
                        <li class="nav-item">
                            <a class="nav-link"
                               href="{{ route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'order']) }}">{{translate('order')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                               href="{{ route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'product']) }}">{{translate('product')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                               href="{{ route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'setting']) }}">{{translate('setting')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                               href="{{ route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'transaction']) }}">{{translate('transaction')}}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                               href="{{ route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'review']) }}">{{translate('review')}}</a>
                        </li>
                    @endif
                </ul>
            </div>
                        ...
                        <div class="media-body">
                            ...
                            <div class="d-block">
                                ...
                                <div class="d-flex gap-3 flex-wrap mb-3 lh-1">
                                    ...
                                    <span class="border-left"></span>
                                    <a href="{{ $seller['status']!="pending" ? route('admin.dropshippers.view',['id'=>$seller['id'], 'tab'=>'review']): 'javascript:' }}"
