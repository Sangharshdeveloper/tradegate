                    ...
                    <div class="row gx-2">
                        ...
                        <div class="col-12">
                            <div class="d-flex gap-3 justify-content-end">
                                <a href="{{ route('supplier.products.list', ['type'=>request('type')]) }}"
                    ...
                    <div class="px-3 py-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 mt-3 mt-lg-0 d-flex flex-wrap gap-3 justify-content-lg-end">
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right">
                                        <li>
                                            <a class="dropdown-item"
                                               href="{{ route('supplier.products.export-excel', ['type'=>$type,'brand_id'=>request('brand_id'),'category_id'=>request('category_id'),'sub_category_id'=>request('sub_category_id'),'sub_sub_category_id'=>request('sub_sub_category_id'),'searchValue'=>request('searchValue')]) }}">
                                ...
                                @if($type != 'new-request' )
                                <a href="{{ route('supplier.products.stock-limit-list') }}" class="btn btn-info">
                                    <i class="tio-add-circle"></i>
                                    <span class="text">{{ translate('limited_Stocks') }}</span>
                                </a>
                                <a href="{{ route('supplier.products.add') }}" class="btn btn--primary">
                                    <i class="tio-add"></i>
                        ...
                        <table id="datatable"
                            ...
                            @foreach($products as $key=>$product)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('supplier.products.view', [$product['id']]) }}"
                                    ...
                                    @if($type != 'new-request' )
                                        <td class="text-center">
                                            ...
                                            <form action="{{ route('supplier.products.status-update') }}" method="post" data-from="product-status"
                                        ...
                                        <div class="d-flex justify-content-center gap-2">
                                            @if($type != 'new-request' )
                                                <a class="btn btn-outline-info btn-sm square-btn"
                                                   ...
                                                   href="{{ route('supplier.products.barcode', [$product['id']]) }}">
                                                    <i class="tio-barcode"></i>
                                                </a>
                                                <a class="btn btn-outline-info btn-sm square-btn" title="{{ translate('view') }}"
                                                   href="{{ route('supplier.products.view', [$product['id']]) }}">
                                                    <i class="tio-invisible"></i>
                                                </a>
                                            @endif
                                            <a class="btn btn-outline--primary btn-sm square-btn"
                                               title="{{ translate('edit') }}"
                                               href="{{ route('supplier.products.update',[$product['id']]) }}">
                                                <i class="tio-edit"></i>
                                            </a>
