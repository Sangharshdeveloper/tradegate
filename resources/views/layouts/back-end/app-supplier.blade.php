...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-supplier._header')
    @include('layouts.back-end.partials-supplier._side-bar')

    <main id="content" role="main" class="main pointer-event">
        @yield('content')

        @include('layouts.back-end.partials-supplier._footer')

        @include('layouts.back-end.partials-supplier._modals')

        @include('layouts.back-end.partials-supplier._toggle-modal')
        @include('layouts.back-end._translator-for-js')
        @include('layouts.back-end.partials-supplier._sign-out-modal')
