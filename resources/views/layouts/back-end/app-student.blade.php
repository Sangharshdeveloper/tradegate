...
<body class="footer-offset">
    ...
    @include('layouts.back-end.partials-student._header')
    @include('layouts.back-end.partials-student._side-bar')

    <main id="content" role="main" class="main pointer-event">
        @yield('content')

        @include('layouts.back-end.partials-student._footer')

        @include('layouts.back-end.partials-student._modals')

        @include('layouts.back-end.partials-student._toggle-modal')
        @include('layouts.back-end._translator-for-js')
        @include('layouts.back-end.partials-student._sign-out-modal')
    ...
    <span id="get-product-stock-view"
          data-stock-limit-page="{{route('student.products.stock-limit-list')}}"
    >
    </span>
