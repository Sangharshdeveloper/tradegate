            ...
            <div class="navbar-vertical-footer-offset pb-0">
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if(Helpers::module_permission_check('warehouse_management'))
                        <li class="nav-item {{(Request::is('admin/brand*') || Request::is('admin/category*') || Request::is('admin/sub*') || Request::is('admin/attribute*') || Request::is('admin/products*'))?'scroll-here':''}}">
                            <small class="nav-subtitle"
                                title="">Warehouse Management</small>
                            <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{(Request::is('admin/products/'.Product::LIST[URI].'/in-house') || Request::is('admin/products/'.Product::BULK_IMPORT[URI]) || (Request::is('admin/products/'.Product::ADD[URI])) || (Request::is('admin/products/'.Product::VIEW[URI].'/in-house/*')) || (Request::is('admin/products/'.Product::BARCODE_GENERATE[URI].'/*'))|| (Request::is('admin/products/'.Product::UPDATE[URI].'/*') && request()->has('product-gallery')))?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{(Request::is('admin/warehouse-products/'.Product::ADD[URI].'/ware-house') || (Request::is('admin/warehouse-products/'.Product::LIST[URI].'/ware-house')) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::STOCK_LIMIT[URI].'/ware-house')) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::BULK_IMPORT[URI])) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::ADD[URI])) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/ware-house/*')) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::BARCODE_GENERATE[URI].'/*'))||(Request::is('admin/warehouse-products/'.Product::UPDATE[URI].'/*') && request()->has('product-gallery')))?'block':''}}">
                                <li class="nav-item {{(Request::is('admin/warehouse-products/'.Product::LIST[URI].'/ware-house') || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/ware-house/*')) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::STOCK_LIMIT[URI].'/ware-house')) || (Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::BARCODE_GENERATE[URI].'/*')))?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.warehouse-products.list',['ware-house'])}}"
                                        title="{{translate('Product_List')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('Product_List')}}
                                            <span class="badge badge-soft-success badge-pill ml-1">
                                ...
                                <li class="nav-item {{Request::is('admin/warehouse-products/'.Product::ADD[URI]) || (Request::is('admin/warehouse-products/'.Product::UPDATE[URI].'/*') && request()->has('product-gallery')) ?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.warehouse-products.add')}}"
                                        title="{{translate('add_New_Product')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('add_New_Product')}}</span>
                                    </a>
                                </li>
                                <li class="nav-item {{Request::is('admin/warehouse-products/'.Product::BULK_IMPORT[URI])?'active':''}}">
                                    <a class="nav-link " href="{{route('admin.warehouse-products.bulk-import')}}"
                                        title="{{translate('bulk_import')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('bulk_import')}}</span>
                                    </a>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('admin/warehouse-products/'.Product::LIST[URI].'/vendor*')||(Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::VIEW[URI].'/vendor/*'))||Request::is('admin/warehouse-products/'.\App\Enums\ViewPaths\Admin\Product::UPDATED_PRODUCT_LIST[URI])?'active':''}}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                ...
                                <li class="nav-item {{str_contains(url()->current().'?status='.request()->get('status'),'/admin/warehouse-products/'.Product::LIST[URI].'/vendor?status=1')==1?'active':''}}">
                                    <a class="nav-link"
                                        title="{{translate('approved_Products')}}"
                                        href="{{route('admin.supplier-products.list',['vendor', 'status'=>'1'])}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">{{translate('approved_Products')}}
                                            <span class="badge badge-soft-success badge-pill ml-1">
                                                {{getVendorProductsCount('approved')}}
                        ...
                        <li class="navbar-vertical-aside-has-menu {{ Request::is('admin/vendors*') || Request::is('admin/vendors/withdraw-method/*') || (Request::is('admin/orders/details/*') && request()->has('vendor-order-list')) ? 'active' : '' }}">
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                style="display: {{Request::is('admin/suppliers*') || (Request::is('admin/orders/details/*') && request()->has('vendor-order-list'))?'block':'none'}}">
                                <li class="nav-item {{Request::is('admin/suppliers/'.Supplier::ADD[URI])?'active':''}}">
                                    <a class="nav-link" title="{{translate('add_New_Vendor')}}"
                                        href="{{route('admin.suppliers.add')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{'Add new suppliers'}}
                                        </span>
                                ...
                                <li class="nav-item {{Request::is('admin/suppliers/'.Supplier::LIST[URI]) ||Request::is('admin/suppliers/'.Supplier::VIEW[URI].'*') ?'active':''}}">
                                    <a class="nav-link" title="Suppliers list"
                                        href="{{route('admin.suppliers.suppliers-list')}}">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate">
                                            {{'Suppliers list'}}
                                        </span>
