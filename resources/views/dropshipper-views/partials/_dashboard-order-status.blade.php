<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_pending" href="{{route('dropshipper.orders.list',['pending'])}}">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_confirmed" href="{{route('dropshipper.orders.list',['confirmed'])}}">
        <div class="order-stats__content">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_packaging" href="{{route('dropshipper.orders.list',['processing'])}}">
        <div class="order-stats__content">
...
<div class="col-sm-6 col-lg-3">
    <a class="order-stats order-stats_out-for-delivery" href="{{route('dropshipper.orders.list',['out_for_delivery'])}}">
        <div class="order-stats__content">
...
<div class="ol-sm-6 col-lg-3">
    <a class="order-stats order-stats_delivered" href="{{route('dropshipper.orders.list',['delivered'])}}">
        <div class="order-stats__content">
...
<div class="ol-sm-6 col-lg-3">
    <a class="order-stats order-stats_canceled" href="{{route('dropshipper.orders.list',['canceled'])}}">
        <div class="order-stats__content">
...
<div class="ol-sm-6 col-lg-3">
    <a class="order-stats order-stats_returned" href="{{route('dropshipper.orders.list',['returned'])}}">
        <div class="order-stats__content">
...
<div class="ol-sm-6 col-lg-3">
    <a class="order-stats order-stats_failed" href="{{route('dropshipper.orders.list',['failed'])}}">
        <div class="order-stats__content">
